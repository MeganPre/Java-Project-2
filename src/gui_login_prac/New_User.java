...
public class New_User extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbAge.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "1-2", "3-4", "5-6" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtSur)
                            .addComponent(txtCell, javax.swing.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)))
                    .addComponent(txtAddress)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(cmbGen, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(74, 74, 74)
                        .addComponent(jLabel8, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(cmbAge, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        try{
            ...
            String user = "insert into users(ID, name, surname, cell, address, gender, age, email) values(?'?)";
            
            //creates statement
            Statement state = con.createStatement();
            state.executeUpdate("insert into users(ID, name, surname, cell, address, gender, age, email) values('"+id+"', '"+name+"', '"+surname+"', "
                    + "'"+cell+"', '"+address+"', '"+gender+"', '"+age+"', '"+email+"')");
            ...
            txtCell.setText("");
            txtAddress.setText("");
            cmbGen.setSelectedItem(0);
            cmbAge.setSelectedItem(0);
            txtEmail.setText("");
            }
        }catch(Exception e){
            e.printStackTrace();
